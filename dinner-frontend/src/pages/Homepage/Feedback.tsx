...
const Feedback = () => {
    return (
        <div className="bg-[#1E2328] text-white py-20 px-16 flex justify-between items-center">
            {/* Left Section */}
            ...
            <div className="flex space-x-8">
                {/* Feedback Box 1 */}
                <div className="border border-yellow-400 p-8 w-96 text-lg relative rounded-lg">
                    {/* Quotation Mark */}
                ...
                {/* Feedback Box 2 */}
                <div className="border border-yellow-400 p-8 w-96 text-lg flex flex-col justify-between relative rounded-lg">
                    {/* Quotation Mark */}
                    <span className="absolute font-newsreader -top-4 left-4 text-yellow-400 text-5xl bg-[#1E2328] px-2">“</span>
                    <p className="italic text-base leading-relaxed">
